document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "SendyApi");
        setContent('header', 'textContent', settings.name || "SendyApi");
        setContent('name', 'textContent', settings.name || "SendyApi");
